...
IPV6INIT=yes
IPV6ADDR=_virtualmaster_ipv6_address_/_virtualmaster_ipv6_netmask_
IPV6_DEFAULTGW=_virtualmaster_ipv6_gateway_

#
# Disable TCP checksumming, which might resolve problems for some users.
